const footer = () => {
    return (
        <footer className="bg-black text-white rounded-lg shadow dark:bg-gray-900 m-4 py-5 md:py-10">
            <div className="w-full max-w-screen-xl mx-auto px-4 py-10 md:py-8">
                <div className="sm:flex sm:items-center sm:justify-between">
                    ...
                    <ul className="flex flex-wrap items-center mb-6 text-sm font-medium text-gray-200 sm:mb-0 dark:text-gray-400 mt-5 md:mt-0">
                        <li>
